        ...
        <div className="grid gap-12 lg:grid-cols-2 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              ...
              {`We don't just teach courses; we build careers. Our platform is
              designed to provide you with the practical tools and community
              support you need to succeed in the modern job market.`}
            </p>
