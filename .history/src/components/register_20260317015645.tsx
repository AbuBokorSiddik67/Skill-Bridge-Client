...
export default function Register() {
  ...
  const onSubmit = async (data: RegisterFormValues) => {
    try {
      ...
      Example: const res = await createUser(data);
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-6">
      <div className="w-full max-w-2xl space-y-8 bg-card p-8 rounded-2xl border shadow-sm">
        ...
        >
          ...
          <div className="space-y-2">
            <Label>Role</Label>
            <Select onValueChange={(value) => setValue("role", value as "STUDENT" | "TUTOR")}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Phone className="absolute left-3 top-2 h-4 w-4 text-muted-foreground" />
              <Input
                {...register("phone")}
                id="phone"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <ImageIcon className="absolute left-3 top-2 h-4 w-4 text-muted-foreground" />
              <Input
                {...register("imageLink")}
                id="imageLink"
